                ...
                <div className='bg-[#283046] p-4 rounded-md'>
                    <div className='h-[70px] flex justify-center items-center'>
                        <div className='w-[180px] h-[50px]'>
                            <img className='w-full h-full' src="https://res.cloudinary.com/dxgj7zw2w/image/upload/v1727028959/hkf3eyi3egp4lcnbajgs.png" height='150px' width='100px' alt="image" />
                        </div>
                    </div>
