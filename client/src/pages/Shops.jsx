                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            ...
                            <div className='py-3 flex flex-col gap-4'>
                                ...
                                <div className='flex flex-col gap-3'>
                                    {[5, 4, 3, 2, 1].map((rate) => (
                                        <div key={rate} onClick={() => setRatingQ(rate)} className='text-orange-500 flex justify-start items-start gap-2 text-xl cursor-pointer'>
                                            {[...Array(5)].map((_, i) => (
                                                i < rate ? <AiFillStar key={i} /> : <CiStar key={i} />
                                            ))}
                                        </div>
                                    ))}
                                    <div onClick={resetRating} className='text-orange-500 flex justify-start items-start gap-2 text-xl cursor-pointer'>
