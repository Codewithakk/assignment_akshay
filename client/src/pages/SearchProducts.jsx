...
const SearchProducts = () => {
    ...
    }, [dispatch, state.values, category, rating, pageNumber, sortPrice, searchValue]);
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            ...
                            <div className='py-3 flex flex-col gap-4'>
                                ...
                                <div className='flex flex-col gap-3'>
                                    {[5, 4, 3, 2, 1].map((star) => (
                                        <div key={star} onClick={() => setRatingQ(star)} className='text-orange-500 flex justify-start items-start gap-2 text-xl cursor-pointer'>
                        ...
                        <div className='w-9/12 md-lg:w-8/12 md:w-full'>
                            <div className='pl-8 md:pl-0'>
                                ...
                                <div>
                                    {totalProduct > parPage && <Pagination pageNumber={pageNumber} setPageNumber={setPageNumber} totalItem={totalProduct} parPage={parPage} />}
                                </div>
                            </div>
                        </div>
                    </div>
